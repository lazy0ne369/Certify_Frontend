    ...
    return (
        <div className={`min-h-screen public-app-shell ${className}`}>
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
                ...
                <div className="absolute left-[-10%] top-0 h-72 w-72 rounded-full bg-[rgba(214,195,160,0.26)] blur-3xl dark:bg-[rgba(92,183,177,0.1)]" />
                <div className="absolute right-[-4%] top-[12%] h-80 w-80 rounded-full bg-[rgba(23,107,104,0.14)] blur-3xl dark:bg-[rgba(92,183,177,0.12)]" />
            </div>
            <PublicNavbar />
